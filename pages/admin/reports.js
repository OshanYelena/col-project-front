...
export default function Report() {
  ...
  const [studentReports, setStuReports] = useState([]);
  ...
  const getStudentReports = async () => {
    let data = await api.get("/student/job/reviews").then(({ data }) => {
      setStuReports(data);
      console.log(data)
    });
